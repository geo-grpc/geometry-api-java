...
public class TestGGS extends TestCase {
    ...
    public void testMGRSCode() {
        ...
        Polygon result = MGRS.getMGRSPolygon("12U", true);
        ...
        result = MGRS.getMGRSPolygon("4Q", true);
        result.queryEnvelope(resultEnv);
        assertEquals(envelope.getXMax(), resultEnv.getXMax());
        assertEquals(envelope.getXMin(), resultEnv.getXMin());
        assertEquals(envelope.getYMax(), resultEnv.getYMax());
        ...
        result = MGRS.getMGRSPolygon("12U", true);
        assertTrue(OperatorContains.local().execute(result, new Point(-112.61440, 50.00820), null, null));

        result = MGRS.getMGRSPolygon("12U UA", true);
        assertTrue(OperatorContains.local().execute(result, new Point(-112.61440, 50.00820), null, null));

        result = MGRS.getMGRSPolygon("12U UA 8 4", true);
        assertTrue(OperatorContains.local().execute(result, new Point(-112.61440, 50.00820), null, null));
        result = MGRS.getMGRSPolygon("12U UA 84323 40791", true);
        assertTrue(OperatorContains.local().execute(result, new Point(-112.61440, 50.00820), null, null));
        result = MGRS.getMGRSPolygon("12U UA 8432 4079", true);
        assertTrue(OperatorContains.local().execute(result, new Point(-112.61440, 50.00820), null, null));
        result = MGRS.getMGRSPolygon("12U UA 843 407", true);
        assertTrue(OperatorContains.local().execute(result, new Point(-112.61440, 50.00820), null, null));
        result = MGRS.getMGRSPolygon("12U UA 84 40", true);
        assertTrue(OperatorContains.local().execute(result, new Point(-112.61440, 50.00820), null, null));
    }
    ...
    public void testRoundTrip() {
        ...
        while (randCount++ < 400) {
            ...
            for (MGRS.Zoom zoom : somethingList) {
                String code = MGRS.getMGRSPosition(point.getX(), point.getY(), zoom);
                if (zoom == MGRS.Zoom.LevelGridZone) {
                    Polygon result = MGRS.getMGRSPolygon(code, true);
                    ...
                    Polygon result = MGRS.getMGRSPolygon(code, false);
                    result.queryEnvelope(envelope);
                    assertTrue(String.format(
                            "\ntest number: %d\npt: %s\ncode: %s\nenvelope: %s\n",
                            randCount,
...
//                String code2 = MGRS.getMGRSPosition(envelope.getXMin(), envelope.getYMin(), zoom);
//                assertEquals(String.format("\n%d\npt: %s\nenv: %s\n", randCount, point, envelope), code, code2);
    ...
    envelope: 14.970905, -45.700687, 16.226223, -45.341274
        ...
        Polygon result = MGRS.getMGRSPolygon("33G", true);
        assertTrue(OperatorContains.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("33G VL", true);
        assertTrue(OperatorContains.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("33G VL 9 3", true);
        assertTrue(OperatorContains.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("33G VL 97 39", true);
        assertTrue(OperatorContains.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("33G VL 977 392", true);
        assertTrue(OperatorContains.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("33G VL 9773 3920", true);
        assertTrue(OperatorContains.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("33G VL 97735 39207", true);
        assertTrue(OperatorContains.local().execute(result, pt, null, null));
    }
    ...
    envelope: 8.000436, -88.027989, 19.800078, -87.761320
        ...
        Polygon result = MGRS.getMGRSPolygon("30C", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("30C WS", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("30C WS 45277 17504", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
    }
    ...
    envelope: -15.138683, 74.318858, -12.328319, 74.981807
        ...
        Polygon result = MGRS.getMGRSPolygon("27V", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("27V XC", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("27V XC 75682 65297", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
...
envelope: -30.000000, 72.000000, -24.000000, 80.000000
        ...
        Polygon result = MGRS.getMGRSPolygon("26X", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
//        result = MGRS.getMGRSPolygon("27V XC", true);
//        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
//        result = MGRS.getMGRSPolygon("27V XC 75682 65297", true);
//        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
    ...
    public void testScenario5() {
        ...
        Polygon result = MGRS.getMGRSPolygon("8M", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("8M QC", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
        result = MGRS.getMGRSPolygon("8M QC 47466 28050", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
    }
...
envelope: Envelope: [-125.39323359521163, -77.02861215838094, -123.383491378233, -76.48074053627055]
        ...
        Polygon result = MGRS.getMGRSPolygon("10C DV 4 5", true);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
    }
...
envelope: Envelope: [-96.13180313970017, -30.716083310981194, -95.06959008486949, -29.79401200205343]
        ...
        Polygon result = MGRS.getMGRSPolygon("15J", false);
        assertTrue(OperatorIntersects.local().execute(result, pt, null, null));
        Envelope envelope = new Envelope();
        result.queryEnvelope(envelope);
    ...
    public void testBasics() {
        ...
        String code = MGRS.getMGRSPosition(point.getX(), point.getY(), MGRS.Zoom.LevelGridZone);
        Polygon result = MGRS.getMGRSPolygon(code, true);
        assertTrue(OperatorIntersects.local().execute(result, point, null, null));

        result = MGRS.getMGRSPolygon(code, false);
        result.queryEnvelope(envelope);
        assertEquals(500000.0, envelope.getCenterX(), .00001);


        code = MGRS.getMGRSPosition(point.getX(), point.getY(), MGRS.Zoom.Level100K);
        result = MGRS.getMGRSPolygon(code, true);
        assertTrue(OperatorIntersects.local().execute(result, point, null, null));
        result = MGRS.getMGRSPolygon(code, false);
        ...
        code = MGRS.getMGRSPosition(point.getX(), point.getY(), MGRS.Zoom.Level10K);
        result = MGRS.getMGRSPolygon(code, true);
        assertTrue(OperatorIntersects.local().execute(result, point, null, null));
        ...
        code = MGRS.getMGRSPosition(point.getX(), point.getY(), MGRS.Zoom.Level1K);
        result = MGRS.getMGRSPolygon(code, true);
        assertTrue(OperatorIntersects.local().execute(result, point, null, null));
        ...
        code = MGRS.getMGRSPosition(point.getX(), point.getY(), MGRS.Zoom.Level100M);
        result = MGRS.getMGRSPolygon(code, true);
        assertTrue(OperatorIntersects.local().execute(result, point, null, null));
        ...
        code = MGRS.getMGRSPosition(point.getX(), point.getY(), MGRS.Zoom.Level10M);
        result = MGRS.getMGRSPolygon(code, true);
        assertTrue(OperatorIntersects.local().execute(result, point, null, null));
        ...
        code = MGRS.getMGRSPosition(point.getX(), point.getY(), MGRS.Zoom.Level1M);
        result = MGRS.getMGRSPolygon(code, true);
        assertTrue(OperatorIntersects.local().execute(result, point, null, null));
