...
public class TestSpatialReference extends TestCase {
    ...
    public void testWKTToWkid() {
        ...
        SpatialReference spatialReference = SpatialReference.create(test1);
        ...
        String test2 = "GEOGCS[\n" +
                ...
                "\n" +
                "\t]";
        SpatialReference spatialReference2 = SpatialReference.create(test2);
        ...
        SpatialReference spatialReference3 = SpatialReference.create(test3);
        ...
        SpatialReference spatialReference5 = SpatialReference.create(customWKT);
