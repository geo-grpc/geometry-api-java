...
public class TestProjection extends TestCase {
    ...
    public void testExampleLAEA_bug() {
        double distance = 800;
        SpatialReference spatialReferenceLAEAeurope = SpatialReference.create(3035);
        ...
        double distanceEast = SpatialReferenceImpl.geodesicDistanceOnWGS84Impl(europeCenter, reprojected200mE);
        double distanceNorth = SpatialReferenceImpl.geodesicDistanceOnWGS84Impl(europeCenter, reprojected200mN);
        ...
        distanceEast = SpatialReferenceImpl.geodesicDistanceOnWGS84Impl(europeCenter, reprojected200mE);
        distanceNorth = SpatialReferenceImpl.geodesicDistanceOnWGS84Impl(europeCenter, reprojected200mN);
        assertEquals(distance, distanceNorth, 1e-3);
        assertEquals(distance, distanceEast, 1e-6);
    ...
    public void testEqualAreaProjection() {
        ...
        SpatialReference utmZone = SpatialReference.createUTM(point);
        SpatialReference spatialReferenceWGS84 = SpatialReference.create(4326);
        ...
        Geometry utmPoint = GeometryEngine.project(point, spatialReferenceWGS84, utmZone);
        ...
        Geometry utmReprojected = GeometryEngine.project(utmPoint, utmZone, spatialReferenceWGS84);
        ...
        Geometry utmBuffer = OperatorBuffer.local().execute(utmPoint, utmZone, 135.6, null);
        Geometry reProjectedUTMBuffer = OperatorProject.local().execute(utmBuffer, projectionTransformationUTM.getReverse(), null);
        double differenceVal = GeometryEngine.difference(reProjectedUTMBuffer, geodesicBuffered, spatialReferenceWGS84).calculateArea2D();
        assertEquals(differenceVal, 0.0, 1e-14);

        assertTrue(GeometryEngine.contains(geodesicBuffered, reProjectedUTMBuffer, spatialReferenceWGS84));
        ...
        differenceVal = GeometryEngine.difference(reProjectedAZIBuffer, reprojectedGeodesicAZI, spatialReferenceWGS84).calculateArea2D();
        assertEquals(differenceVal, 0.0, 1e-14);

        differenceVal = GeometryEngine.difference(reProjectedAZIBuffer, geodesicBuffered, spatialReferenceWGS84).calculateArea2D();
        assertEquals(differenceVal, 0.0, 1e-14);

        assertTrue(GeometryEngine.contains(geodesicBuffered, reProjectedAZIBuffer, spatialReferenceWGS84));
