...
//            if (bDoJoin) {
//                m_buffer_commands.add(new GeodesicBufferCommand(pt_left_prev, pt,
//                        pt_current, GeodesicBufferCommand.Flags.enum_arc,
//                        m_buffer_commands.size() + 1,
//                        m_buffer_commands.size() - 1));
//            } else if (!pt_left_prev.isEqual(pt)) {
//                m_buffer_commands.add(new GeodesicBufferCommand(pt_left_prev,
//                        pt_current, m_buffer_commands.size() + 1,
//                        m_buffer_commands.size() - 1, "dummy"));
//                m_buffer_commands.add(new GeodesicBufferCommand(pt_current, pt,
//                        m_buffer_commands.size() + 1,
//                        m_buffer_commands.size() - 1, "dummy"));
//            }
//
...
//            m_buffer_commands
//                    .add(new GeodesicBufferCommand(pt, pt1, pt_current,
//                            GeodesicBufferCommand.Flags.enum_line, m_buffer_commands
