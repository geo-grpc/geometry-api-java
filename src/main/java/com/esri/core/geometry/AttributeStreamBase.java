...
abstract class AttributeStreamBase {
     ...
     * the same type.
     *
     * @param src      The source stream to read elements from.
     * @param srcStart The index of the element in the source stream to start reading
     *                 from.
     * @param count    The number of elements to add.
     * @param bForward True if adding the elements in order of the incoming source
     *                 stream. False if adding the elements in reverse.
     * @param stride   The number of elements to be grouped together if adding the
     *                 elements in reverse.
     */
     ...
     * of the same type.
     *
     * @param start     The index where to start the insert.
     * @param src       The source stream to read elements from.
     * @param srcStart  The index of the element in the source stream to start reading
     *                  from.
     * @param count     The number of elements to read from the source stream.
     * @param validSize The number of valid elements in this stream.
     */
     ...
     *
     * @param start     The index where to start the insert.
     * @param pt        The Point geometry holding the attributes to be inserted.
     * @param semantics The attribute semantics that are being inserted.
     * @param validSize The number of valid elements in this stream.
     */
     ...
     *
     * @param value The value to set stream elements to.
     * @param start The index of the element to start writing to.
     ...
     *
     * @param startElement the index of the element in this stream to start setting
     *                     elements from.
     * @param count        The number of AttributeStream elements to read.
     * @param src          The source ByteBuffer to read elements from.
     * @param sourceStart  The offset from the start of the ByteBuffer in bytes.
     * @param bForward     When False, the source is written in reversed order.
     * @param stride       Used for reversed writing only to indicate the unit of
     ...
     * @param count        The number of AttributeStream elements to read.
     * @param src          The source ByteBuffer to read elements from.
     * @param offsetBytes  The offset from the start of the ByteBuffer in bytes.
     */
    public abstract void writeRange(int startElement, int count,
     ...
     *
     * @param srcStart       The element index to start writing from.
     * @param count          The number of AttributeStream elements to write.
     * @param dst            The destination ByteBuffer. The buffer must be large enough or
     *                       it will throw.
     * @param dstOffsetBytes The offset in the destination ByteBuffer to start write
     *                       elements from.
     */
     ...
     *
     * @param index     The index in this stream where the erasing starts.
     ...
     *
     * @param index  The index in this stream where the reversing starts.
     * @param count  The number of elements to be reversed.
     * @param stride The number of elements to be grouped together when doing the
     *               reverse.
     */
     ...
     *
     * @param size         The number of elements in the stream.
     * @param defaultValue The default value to fill the stream with.
     */
    public static AttributeStreamBase createByteStream(int size,
                                                       byte defaultValue) {
        AttributeStreamBase newStream = new AttributeStreamOfInt8(size,
     ...
     *
     * @param persistence The persistence type of the stream (see VertexDescription).
     * @param size        The number of elements (floats, doubles, or 32 bit integers)
     ...
     *
     * @param semantics   The semantics of the attribute (see VertexDescription).
     * @param vertexCount The number of vertices in the geometry. The actual number of
