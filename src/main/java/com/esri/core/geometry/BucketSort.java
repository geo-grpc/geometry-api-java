...
final class BucketSort {
	 ...
	 *
	 * @param bucket_count - the number of buckets. Usually equal to the number of
	 *                     elements to sort.
	 * @param min_value    - the minimum value of elements to sort.
	 * @param max_value    - the maximum value of elements to sort.
	 * @param capacity     - the number of elements to sort (-1 if not known). The
	 ...
	 *
	 * @param The value used for bucketing.
	 * @param The index of the element to store in the buffer. Usually it is an
