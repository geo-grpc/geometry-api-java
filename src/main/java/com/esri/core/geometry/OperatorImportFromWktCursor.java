...
public class OperatorImportFromWktCursor extends GeometryCursor {
    ...
    public Geometry next() {
        if (hasNext()) {
            return postProject(OperatorImportFromWkt.local().execute(
                    m_importFlags,
    ...
    @Override
    public SimpleStateEnum getSimpleState() { return m_wktStringCursor.getSimpleState(); }

    @Override
    public String getFeatureID() { return m_wktStringCursor.getFeatureID(); }
}
