...
public abstract class RasterizedGeometry2D {
	 ...
	 *
	 * @param geom            The input geometry to rasterize. It has to be a MultiVertexGeometry instance.
	 * @param toleranceXY     The tolerance of the rasterization. Raster pixels that are
	 *                        closer than given tolerance to the Geometry will be set.
	 * @param rasterSizeBytes The max size of the raster in bytes. The raster has size of
